...
public class DbcpDataSourceInfo implements DataSourceInfo {
    ...
    public void validate() {
        CommFun.usernameIsNullWriteLogerWarnByValue(driverClassName, "{} : driverClassName shouldnot be null",name);
        CommFun.usernameIsNullWriteLogerWarnByValue(url, "{} : url shouldnot be null",name);
        CommFun.usernameIsNullWriteLogerWarnByValue(username, "{} : username shouldnot be null",name);
        CommFun.usernameIsNullWriteLogerWarnByValue(password, "{} : password shouldnot be null",name);
    }
